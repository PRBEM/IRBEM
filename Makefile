...
#------------------------------------------------------------------------------
# store #(IRBEM_TSO7D_DIR) in ts07d.inc
#------------------------------------------------------------------------------

ts07d:
	@echo "        CHARACTER*80 TS07D_DIR ! generated by Make File" > $(SOURCEDIR)/ts07d.inc ; \
	 echo "        PARAMETER (TS07D_DIR = \""$(TS07D_DIR)"\") ! Generated by Make File" >> $(SOURCEDIR)/ts07d.inc
